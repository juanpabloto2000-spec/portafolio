export const LIVE_PROJECTS = [
  ...
  },
  {
    ...
    nicheId: "esteticas",
    nicheLabel: "Clínicas Estéticas & Mirada",
    title: "Lorena Terranova Studio",
    client: "Lorena Terranova Beauty",
    url: "lorenaterranova.netlify.app",
    liveUrl: "https://lorenaterranova.netlify.app/",
    isFlagship: false,
    tagline: "Estudio especializado en diseño de cejas, extensiones de pestañas y micropigmentación",
    description: "Catálogo editorial de servicios estéticos, portafolio de resultados visuales y sistema de reserva de citas para tratamientos faciales.",
  ...
  },
  {
    ...
    title: "DYM Store | Catálogo & Venta Directa",
    client: "DYM Store",
    url: "6a7d0ecaaa2fdc1cf64c1d0f--heartfelt-gecko-019d45.netlify.app",
    liveUrl: "https://6a7d0ecaaa2fdc1cf64c1d0f--heartfelt-gecko-019d45.netlify.app",
    isFlagship: false,
